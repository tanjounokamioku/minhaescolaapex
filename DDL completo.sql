CREATE TABLE  "ALUNO" 
   (	"COD" NUMBER NOT NULL ENABLE, 
	...
	"IND_SEXO" CHAR(1) NOT NULL ENABLE, 
	"ENDERECO_COMPLETO" VARCHAR2(200), 
	"TELEFONE" VARCHAR2(20), 
	"EMAIL" VARCHAR2(20) NOT NULL ENABLE, 
	 CONSTRAINT "ALUNO_PK" PRIMARY KEY ("COD")
  USING INDEX  ENABLE, 
	 CONSTRAINT "ALUNO_CK_IND_SEXO" CHECK (IND_SEXO IN ('M', 'F')) ENABLE
   )
/
CREATE TABLE  "TURMA" 
   (	"COD" NUMBER NOT NULL ENABLE, 
	"DESCRICAO" VARCHAR2(50) NOT NULL ENABLE, 
	"PERIODO" VARCHAR2(50) NOT NULL ENABLE, 
	"HORARIO" VARCHAR2(50) NOT NULL ENABLE, 
	"SALA" VARCHAR2(20) NOT NULL ENABLE, 
	"QTDE_VAGAS" NUMBER NOT NULL ENABLE, 
	"VALOR_CURSO" NUMBER NOT NULL ENABLE, 
	"IND_SITUACAO" CHAR(1) NOT NULL ENABLE, 
	 CONSTRAINT "TURMA_PK" PRIMARY KEY ("COD")
  USING INDEX  ENABLE, 
	 CONSTRAINT "TURMA_CK_QTD_VAGAS" CHECK (qtde_vagas >= 0) ENABLE, 
	 CONSTRAINT "TURMA_CK_VALOR_CURSO" CHECK (valor_curso >= 0) ENABLE, 
	 CONSTRAINT "TURMA_CK_IND_SITUACAO" CHECK (IND_SITUACAO in ('M', 'A', 'E')) ENABLE
   )
/
CREATE TABLE  "ALUNO_TURMA" 
   (	"COD" NUMBER NOT NULL ENABLE, 
	"COD_ALUNO" NUMBER NOT NULL ENABLE, 
	"COD_TURMA" NUMBER NOT NULL ENABLE, 
	"NOTA" NUMBER NOT NULL ENABLE, 
	 CONSTRAINT "ALUNO_TURMA_PK" PRIMARY KEY ("COD")
  USING INDEX  ENABLE, 
	 CONSTRAINT "ALUNO_TURMA_CK_NOTA" CHECK (nota >= 0) ENABLE
   )
/
...
CREATE TABLE  "PROFESSOR" 
   (	"COD" NUMBER NOT NULL ENABLE, 
	"NOME" VARCHAR2(50) NOT NULL ENABLE, 
	"IND_NIVEL" CHAR(1) NOT NULL ENABLE, 
	"CURRICULO" VARCHAR2(4000), 
	"TELEFONE" VARCHAR2(50), 
	"EMAIL" VARCHAR2(50) NOT NULL ENABLE, 
	 CONSTRAINT "PROFESSOR_PK" PRIMARY KEY ("COD")
  USING INDEX  ENABLE, 
	 CONSTRAINT "PROFESSOR_CK_IND_NIVEL" CHECK (IND_NIVEL in ('F','M','S','P')) ENABLE
   )
/
CREATE TABLE  "PROFESSOR_TURMA" 
   (	"COD" NUMBER NOT NULL ENABLE, 
	"COD_PROFESSOR" NUMBER NOT NULL ENABLE, 
	"COD_TURMA" NUMBER NOT NULL ENABLE, 
	 CONSTRAINT "PROFESSOR_TURMA_PK" PRIMARY KEY ("COD")
  USING INDEX  ENABLE
   )
/
CREATE TABLE  "PAGAMENTO" 
   (	"COD" NUMBER NOT NULL ENABLE, 
	"COD_ALUNO_TURMA" NUMBER NOT NULL ENABLE, 
	"DATA" DATE, 
	"VALOR" NUMBER, 
	 CONSTRAINT "PAGAMENTO_PK" PRIMARY KEY ("COD")
  USING INDEX  ENABLE
   )
/
...
/
ALTER TABLE  "ALUNO_TURMA" ADD CONSTRAINT "ALUNO_TURMA_FK_ALUNO" FOREIGN KEY ("COD_ALUNO")
	  REFERENCES  "ALUNO" ("COD") ENABLE
/
ALTER TABLE  "ALUNO_TURMA" ADD CONSTRAINT "ALUNO_TURMA_FK_TURMA" FOREIGN KEY ("COD_TURMA")
	  REFERENCES  "TURMA" ("COD") ENABLE
/
...
/
ALTER TABLE  "PAGAMENTO" ADD CONSTRAINT "PAGAMENTO_FK_ALUNO_TURMA" FOREIGN KEY ("COD_ALUNO_TURMA")
	  REFERENCES  "ALUNO_TURMA" ("COD") ENABLE
/
ALTER TABLE  "PROFESSOR_TURMA" ADD CONSTRAINT "PROFESSOR_TURMA_FK_PROFESSOR" FOREIGN KEY ("COD_PROFESSOR")
	  REFERENCES  "PROFESSOR" ("COD") ENABLE
/
ALTER TABLE  "PROFESSOR_TURMA" ADD CONSTRAINT "PROFESSOR_TURMA_FK_TURMA" FOREIGN KEY ("COD_TURMA")
	  REFERENCES  "TURMA" ("COD") ENABLE
/
CREATE OR REPLACE EDITIONABLE FUNCTION  "F_QTD_PARTICIPANTE_TURMA" (p_cod_turma NUMBER)
...
CREATE OR REPLACE EDITIONABLE FUNCTION  "F_VALOR_PAGO" (p_cod_aluno_turma NUMBER)
  RETURN NUMBER
IS
  v_total NUMBER;
BEGIN
...
CREATE INDEX  "ALUNO_TURMA_FK_ALUNO" ON  "ALUNO_TURMA" ("COD_ALUNO")
/
CREATE INDEX  "ALUNO_TURMA_FK_TURMA" ON  "ALUNO_TURMA" ("COD_TURMA")
/
...
/
CREATE INDEX  "PAGAMENTO_IDX_COD_ALUNO_TURMA" ON  "PAGAMENTO" ("COD_ALUNO_TURMA")
/
CREATE INDEX  "PROFESSOR_TURMA_FK_PROFESSOR" ON  "PROFESSOR_TURMA" ("COD_PROFESSOR")
/
CREATE INDEX  "PROFESSOR_TURMA_FK_TURMA" ON  "PROFESSOR_TURMA" ("COD_TURMA")
/
CREATE OR REPLACE EDITIONABLE PACKAGE  "PCK_PROFESSOR" 
IS
...
END;
/
CREATE OR REPLACE EDITIONABLE PACKAGE BODY  "PCK_PROFESSOR" 
IS
...
CREATE OR REPLACE EDITIONABLE PACKAGE  "SAMPLE_DATA_PKG" as
  function varchar2_to_blob(p_varchar2_tab in dbms_sql.varchar2_table) return blob;
  procedure delete_data;
  procedure insert_data;
end sample_data_pkg;
/
CREATE OR REPLACE EDITIONABLE PACKAGE BODY  "SAMPLE_DATA_PKG" as
...
begin
  ...
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(1, 'Business Shirt', 'Wrinkle-free cotton business shirt', 'Mens', 'Y', 50, l_blob,'image/jpeg','shirt.jpg',localtimestamp,'Top seller');
  ...
  l_blob := varchar2_to_blob(i);
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(2, 'Trousers', 'Black trousers suitable for every business man', 'Mens', 'Y', 80, l_blob,'image/jpeg','pants.jpg',localtimestamp,'Top seller');
  ...
  l_blob := varchar2_to_blob(i);
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(3, 'Jacket', 'Fully lined jacket which is both professional and extremely comfortable to wear', 'Mens', 'Y', 150, l_blob,'image/jpeg','jacket.jpg',localtimestamp,null);
  ...
  l_blob := varchar2_to_blob(i);      
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(4, 'Blouse', 'Silk blouse ideal for all business women', 'Womens', 'Y', 60, l_blob,'image/jpeg','blouse.jpg',localtimestamp,null);
  ...
  l_blob := varchar2_to_blob(i);   
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(5, 'Skirt', 'Wrinkle free skirt', 'Womens', 'Y', 80,l_blob,'image/jpeg','skirt.jpg',localtimestamp,null);
  ...
  l_blob := varchar2_to_blob(i);    
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(6, 'Ladies Shoes', 'Low heel and cushioned interior for comfort and style in simple yet elegant shoes', 'Womens', 'Y', 120, l_blob,'image/jpeg','heels.jpg',localtimestamp,null);
  ...
  l_blob := varchar2_to_blob(i);
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(7, 'Belt', 'Leather belt', 'Accessories', 'Y', 30, l_blob,'image/jpeg','belt.jpg',localtimestamp,null);
  ...
  l_blob := varchar2_to_blob(i);
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(8, 'Bag', 'Unisex bag suitable for carrying laptops with room for many additional items', 'Accessories', 'Y', 125, l_blob,'image/jpeg','bag.jpg',localtimestamp,null);
  ...
  l_blob := varchar2_to_blob(i);  
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(9, 'Mens Shoes', 'Leather upper and lower lace up shoes', 'Mens', 'Y', 110, l_blob,'image/jpeg','shoes.jpg',localtimestamp,null);
  ...
  l_blob := varchar2_to_blob(i);   
  INSERT INTO demo_product_info (product_id, product_name, product_description, category,product_avail, list_price, product_image, mimetype, filename, image_last_update, tags)
      VALUES(10, 'Wallet', 'Travel wallet suitable for men and women. Several compartments for credit cards, passports and cash', 'Accessories', 'Y', 50, l_blob,'image/jpeg','wallet.jpg',localtimestamp,null);
  ...
  -- Table: DEMO_ORDERS
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(1, 7,0, localtimestamp-65,'DEMO', null);
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(2, 1,0, localtimestamp-51,'DEMO', 'Large Order');
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(3, 2,0, localtimestamp-40,'DEMO', null);
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(4, 5,0, localtimestamp-38,'DEMO', null);
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(5, 6,0, localtimestamp-28,'DEMO', null);
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(6, 3,0, localtimestamp-23,'DEMO', null);
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(7, 3,0, localtimestamp-18,'DEMO', null);
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(8, 4,0, localtimestamp-10,'DEMO', null);
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(9, 2,0, localtimestamp-4,'DEMO', null);
  INSERT INTO demo_orders (order_id, customer_id, order_total, order_timestamp, user_name, tags) VALUES(10, 7,0, localtimestamp-1,'DEMO', null);
...
CREATE OR REPLACE EDITIONABLE PACKAGE  "SAMPLE_PKG" is
    --
...
/
CREATE OR REPLACE EDITIONABLE PACKAGE BODY  "SAMPLE_PKG" as
    --
    -- Error Handling function
    --
    function demo_error_handling (
...
CREATE OR REPLACE EDITIONABLE PROCEDURE  "PROC_ATUALIZA_CURRICULO" 
IS
BEGIN
...
/
 ...
 CREATE SEQUENCE   "ALUNO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "ALUNO_TURMA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "DEMO_CUST_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "DEMO_ORDER_ITEMS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 160 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "DEMO_ORD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 11 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "DEMO_PROD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "DEPT_SEQ"  MINVALUE 1 MAXVALUE 9000 INCREMENT BY 10 START WITH 50 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "EMP_SEQ"  MINVALUE 1 MAXVALUE 90000 INCREMENT BY 10 START WITH 8000 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "PAGAMENTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "PROFESSOR_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "PROFESSOR_TURMA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "TURMA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "BI_ALUNO" 
  before insert on "ALUNO"               
  for each row  
begin   
  if :NEW."COD" is null then 
    select "ALUNO_SEQ".nextval into :NEW."COD" from sys.dual; 
  end if; 
end; 

/
ALTER TRIGGER  "BI_ALUNO" ENABLE
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "BI_ALUNO_TURMA" 
  before insert on "ALUNO_TURMA"               
  for each row  
begin   
  if :NEW."COD" is null then 
    select "ALUNO_TURMA_SEQ".nextval into :NEW."COD" from sys.dual; 
  end if; 
end; 

/
ALTER TRIGGER  "BI_ALUNO_TURMA" ENABLE
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "BI_PAGAMENTO" 
  before insert on "PAGAMENTO"               
  for each row  
begin   
  if :NEW."COD" is null then 
    select "PAGAMENTO_SEQ".nextval into :NEW."COD" from sys.dual; 
  end if; 
end; 

/
ALTER TRIGGER  "BI_PAGAMENTO" ENABLE
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "BI_PROFESSOR" 
  before insert on "PROFESSOR"               
  for each row  
begin   
  if :NEW."COD" is null then 
    select "PROFESSOR_SEQ".nextval into :NEW."COD" from sys.dual; 
  end if; 
end; 

/
ALTER TRIGGER  "BI_PROFESSOR" ENABLE
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "BI_PROFESSOR_TURMA" 
  before insert on "PROFESSOR_TURMA"               
  for each row  
begin   
  if :NEW."COD" is null then 
    select "PROFESSOR_TURMA_SEQ".nextval into :NEW."COD" from sys.dual; 
  end if; 
end; 

/
ALTER TRIGGER  "BI_PROFESSOR_TURMA" ENABLE
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "BI_TURMA" 
  before insert on "TURMA"               
  for each row  
begin   
  if :NEW."COD" is null then 
    select "TURMA_SEQ".nextval into :NEW."COD" from sys.dual; 
  end if; 
end; 

/
ALTER TRIGGER  "BI_TURMA" ENABLE
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_CUSTOMERS_BD" 
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_ORDERS_BD" 
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_ORDERS_BIU" 
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_ORDER_ITEMS_AIUD_TOTAL" 
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_ORDER_ITEMS_BI" 
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_ORDER_ITEMS_BIU_GET_PRICE" 
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_PRODUCT_INFO_BD" 
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_PRODUCT_INFO_BIU" 
...
/
CREATE OR REPLACE EDITIONABLE TRIGGER  "DEMO_TAGS_BIU" 
